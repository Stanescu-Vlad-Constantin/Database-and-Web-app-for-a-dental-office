...
<h1><span>Estetica dentară</span></h1>
									<br>
									<br>
									<p><b>Estetica dentară</b> s-a născut din dorința oamenilor de a avea un zâmbet cât mai frumos, natural și pe termen lung. Conform Academiei Americane de Stomatologie Cosmetică, 89% dintre pacienții care au ales tratamente de estetică dentară și-au îmbunătățit stima de sine și cei din jur i-au considerat ca fiind mai atractivi, după ce au urmat tratamente de estetică dentară.</p>
									<br>
									<br>
</div>
							</div>
		...
		<style>
				...
				<table>
					<tr>
					   ...
					   <th style="color: blue; font-weight: bold;"> <b> Imperfecțiuni corectate cu ajutorul tratamentelor de estetică dentară</b> </th>
					   
					</tr>
											<tr>
						   <td> <li> <b>Spații sau înghesuiri interdentare</b> </li> </td>
						</tr>
						<tr>
						   <td> <li><b> Dinți asimetrici</b> </li> </td>
						   
						</tr>
							<tr>
						   <td> <li><b> Dizarmonie facială</b> </li> </td>
						</tr>
						<tr>
						   <td> <li><b> Traumatisme dentare (dinți ciobiți)</b> </li> </td>
						</tr>
						<tr>
						   <td> <li><b> Dinți cu textură neomogenă</b> </li> </td>
						</tr>
						<tr>
						   <td> <li><b> Culoare inestetică</b> </li> </td>
						</tr>
		...
		<p style ="color: blue; font-weight: bold; font-size: 25px;"> Beneficiile tratamentelor de estetică dentară</p>
		<div>
							</div>
						</div>
					</div>
				...
				<div class="choose-left">
						<div class="row">
								<div class="col-lg-6 col-12">
									<!-- Start Choose Left -->
									<div class="choose-left">
										<p><b>&rarr; Aspect natural al zâmbetului</b></p>
										<p><b>&rarr; Armonizarea trăsăturilor feței</b></p>
										<p><b>&rarr; Lucrările protetice sunt bio-estetice</b></p>
										<p><b>&rarr; Rezultate imediate și fără durere</b></p>
										<p><b>&rarr; Implicare directă a pacientului în alegerea nuanței și formei dinților</b></p>
										<p><b>&rarr; Garanție pe viață și certificat de asumare a calității</b></p>
							...
							<div class="single-footer f-link">
								...
								<div class="row">
									<div class="col-lg-9 col-md-6 col-12">
										<ul>
											<li><a href="#"><i class="fa fa-caret-right" aria-hidden="true"></i>Galeria zâmbetelor</a></li>
											<li><a href="#"><i class="fa fa-caret-right" aria-hidden="true"></i>Testimoniale</a></li>
										</ul>
									</div>
								</div>
							</div>
