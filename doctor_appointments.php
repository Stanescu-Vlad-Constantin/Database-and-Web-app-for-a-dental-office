  ...
  <div class="container">
    <table class="table table-hover text-center">
      ...
      <tbody>
        ...
        $sql = "SELECT p.idProgramare, p.dataProgramare, p.oraProgramare, s.denumireServiciu AS tipServiciu, p.codPacient, pa.numePacient 
        FROM tblProgramari p
        INNER JOIN tblServicii s ON p.tipServiciu = s.idServiciu
        INNER JOIN tblPacienti pa ON p.codPacient = pa.idPacient
        WHERE p.medicAles = $userId
