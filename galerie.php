		...
		<section class="why-choose section" >
			...
			<div class="choose-left">
						<div class="row">
							...
							<h2>Oferim zâmbete de nota 10!</h2>
							</div>
						</div>
						...
						<div class="row">
								<div class="col-lg-12 col-12">
									<!-- Start Choose Left -->
										<h3>Galeria zâmbetelor din clinica Dentaplus</h3>
								</div>	
				...
				<div class="row">
					<div class="col-lg-12 col-12">
						<div class="owl-carousel portfolio-slider">
							...
							<div class="single-pf"> 		   
										<img src="img/gz2.jpg" alt="#"> 
										<p> Stroe Elena, 43 ani </p>
							</div>
							<div class="single-pf"> 			
										<img src="img/gz3.jpg" alt="#">
										<p>	Ursache Corneliu, 34 ani </p>
							</div>
							<div class="single-pf"> 
									    <img src="img/gz4.jpg" alt="#">
										<p> Scărlătescu George, 54 ani </p>		
							</div>
							<div class="single-pf"> 		   
										<img src="img/gz5.jpg" alt="#"> 
										<p> Dumitrache Florentina, 48 ani </p>
							</div>
							<div class="single-pf"> 			
										<img src="img/gz6.jpg" alt="#">
										<p> Chiriac Manuela, 27 ani </p>
							</div>		   
							<div class="single-pf"> 
									    <img src="img/gz7.jpg" alt="#">
										<p> Popa Daniel, 24 ani </p>		
							</div>
							<div class="single-pf"> 		   
										<img src="img/gz8.jpg" alt="#"> 
										<p> Cazacu Adina Maria, 22 ani </p>
							</div>
							<div class="single-pf"> 			
										<img src="img/gz9.jpg" alt="#">
										<p> Marian Vlad, 35 ani </p>
							</div>	
