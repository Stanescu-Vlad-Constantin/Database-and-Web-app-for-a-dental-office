...
<section class="why-choose section" >
    ...
    <div id="role-selection">
        <h1>Bine ai venit! Loghează-te în contul DENTAPLUS.</h1>
       <h1><button onclick="redirectToLogin('doctor')">Doctor</button>
       <button onclick="redirectToLogin('pacient')">Pacient</button></h1>
	</div>
    <script>
